...
- Sheet attack/damage line is **derived** from `BaseHit` + features (sum bonuses, keep base dice + type). Weapon **Use** modal still TODO.
...
- **TODO:** weapon attack Use modal, skill/save *numeric* item bonuses beyond proficiency, starting equipment, rest charge refill, d6/dawn recharge.
